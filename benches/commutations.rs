...
fn bench_commutation_functions(c: &mut Criterion) {
    ...
    c.bench_function("Dx_single_age", |b| {
        b.iter(|| {
            Dx().mt(&mt).i(interest_rate).x(45).call().unwrap()
        })
    });
    
    c.bench_function("Nx_single_age", |b| {
        b.iter(|| {
            Nx().mt(&mt).i(interest_rate).x(45).call().unwrap()
        })
    });
    
    c.bench_function("Cx_single_age", |b| {
        b.iter(|| {
            Cx().mt(&mt).i(interest_rate).x(45).call().unwrap()
        })
    });
    
    c.bench_function("Mx_single_age", |b| {
        b.iter(|| {
            Mx().mt(&mt).i(interest_rate).x(45).call().unwrap()
        })
    });
    ...
    c.bench_function("Dx_with_entry_age", |b| {
        b.iter(|| {
            Dx().mt(&mt).i(interest_rate).x(47).entry_age(45).call().unwrap()
        })
    });
    ...
    c.bench_function("Nx_early_age_intensive", |b| {
        b.iter(|| {
            Nx().mt(&mt).i(interest_rate).x(25).call().unwrap()
        })
    });
    
    c.bench_function("Mx_early_age_intensive", |b| {
        b.iter(|| {
            Mx().mt(&mt).i(interest_rate).x(25).call().unwrap()
        })
    });
    ...
    c.bench_function("Rx_computation", |b| {
        b.iter(|| {
            Rx().mt(&mt).i(interest_rate).x(30).call().unwrap()
        })
    });
    
    c.bench_function("Sx_computation", |b| {
        b.iter(|| {
            Sx().mt(&mt).i(interest_rate).x(30).call().unwrap()
        })
    });
}
