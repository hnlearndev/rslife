...
| :----------: | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: |
|   **MSRV**   |    [![Build Status - MSRV](https://img.shields.io/github/actions/workflow/status/hnlearndev/rslife/rust-1.90.0.yml?branch=main&label=build&style=flat-square)](https://github.com/hnlearndev/rslife/actions/workflows/rust-1.90.0.yml)    |    [![Test Status - MSRV](https://img.shields.io/github/actions/workflow/status/hnlearndev/rslife/rust-1.90.0.yml?branch=main&label=tests&style=flat-square)](https://github.com/hnlearndev/rslife/actions/workflows/rust-1.90.0.yml)    |
