...
pub fn t_AA_x(config: &MortTableConfig, t: i32, x: i32) -> PolarsResult<f64> {
    let result = AA_x(config, x)? - AA_x1_n(config, x, t)?;
    Ok(result)
}
...
pub fn t_AA_x1_n(config: &MortTableConfig, t: i32, x: i32, n: i32) -> PolarsResult<f64> {
    ...
    let aa_xt_n = AA_x1_n(config, x + t, n)?;
    let result = (dxt / dx) * aa_xt_n;
    Ok(result)
}
...
pub fn t_AA_x_n1(config: &MortTableConfig, t: i32, x: i32, n: i32) -> PolarsResult<f64> {
    let result = AA_x_n1(config, x, t + n)?;
    Ok(result)
}
...
pub fn t_IAA_x(config: &MortTableConfig, t: i32, x: i32) -> PolarsResult<f64> {
    let result = IAA_x(config, x)? - IAA_x1_n(config, x, t)?;
    Ok(result)
}
...
pub fn t_IAA_x1_n(config: &MortTableConfig, t: i32, x: i32, n: i32) -> PolarsResult<f64> {
    let dxt = get_value(config, x + t, "Dx")?;
    let dx = get_value(config, x, "Dx")?;
    let iaa_xt_n = IAA_x1_n(config, x + t, n)?;
...
pub fn t_IAA_x_n1(config: &MortTableConfig, t: i32, x: i32, n: i32) -> PolarsResult<f64> {
    let result = IAA_x_n1(config, x, t + n)?;
    Ok(result)
}
...
pub fn t_DAA_x1_n(config: &MortTableConfig, t: i32, x: i32, n: i32) -> PolarsResult<f64> {
    let dxt = get_value(config, x + t, "Dx")?;
    let dx = get_value(config, x, "Dx")?;
    let daa_xt_n = DAA_x1_n(config, x + t, n)?;
...
pub fn t_DAA_x_n1(config: &MortTableConfig, t: i32, x: i32, n: i32) -> PolarsResult<f64> {
    let result = t_AA_x_n1(config, t, x, n)?;
    Ok(result)
}
...
pub fn t_DAA_x_n(config: &MortTableConfig, t: i32, x: i32, n: i32) -> PolarsResult<f64> {
    let result = t_DAA_x1_n(config, t, x, n)? + t_DAA_x_n1(config, t, x, n)?;
    Ok(result)
}
...
pub fn t_gAA_x(config: &MortTableConfig, t: i32, x: i32, g: f64) -> PolarsResult<f64> {
    let result = gAA_x(config, x, g)? - gAA_x1_n(config, x, t, g)?;
    Ok(result)
}
...
pub fn t_gAA_x_n1(config: &MortTableConfig, t: i32, x: i32, n: i32, g: f64) -> PolarsResult<f64> {
    let result = gAA_x_n1(config, x, t + n, g)?;
    Ok(result)
}
...
pub fn t_gAA_x_n(config: &MortTableConfig, t: i32, x: i32, n: i32, g: f64) -> PolarsResult<f64> {
    let result = t_gAA_x1_n(config, t, x, n, g)? + t_gAA_x_n1(config, t, x, n, g)?;
    Ok(result)
}
