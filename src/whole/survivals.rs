...
pub fn tpx(config: &MortTableConfig, t: u32, x: u32, entry_age: Option<u32>) -> PolarsResult<f64> {
...
pub fn tqx(config: &MortTableConfig, t: u32, x: u32, entry_age: Option<u32>) -> PolarsResult<f64> {
